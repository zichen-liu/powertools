...
#'
#' Calculates the number of pairs needed to achieve specified level of power from marginal probabilities
#' and the correlation between probabilities (p1, p2, rho) OR from discordant cell probabilities (p01 and p10).
#'
...
#' mcnemar_ss(p1 = 0.8, p2 = 0.9, rho = 0, alpha = 0.05, power = 0.9)
#' # Calculate sample size supplying cell probabilities at 90% power
#' mcnemar_ss(p10 = 0.18, p01 = 0.08, alpha = 0.05, power = 0.9)
mcnemar_ss <- function(p1 = NULL, p2 = NULL, rho = NULL, p01 = NULL, p10 = NULL,
