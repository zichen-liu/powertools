#' Relative efficiency calculation for cluster randomized or multisite trials
#'
...
pss.re <- function (m, m.sd, icc1) {
  ...
  METHOD <- "Relative efficiency calculation for cluster randomized or multisite trials"
